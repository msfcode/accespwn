								  ...
								  ▀██──██▀██──█──█──█──██▀██──██▀
								   ▀████▀─██──█──█──█──██─▀████▀
								    ▀██▀──██──█──█──█──██──▀██▀
								          ...
								          █▄▄█▄▄█▄▄█▄▄█
                          Accespwn V2.0
                            12/11/2020                       "\u001b[33mwhatever you believe you can achieve\u001b[37m" 
                                                                        tony robbins
  ...
  try:
     ...
     if start == 'help':
      ...
      exit             Exit this famous tool            |              machines                 |                   ATTACK
                                                        |                                       |
                                                        | ipweb         Get Websites Ips        |
      arp spoofing     MITM attack : close connection   |                                       |
...
#launcing the localhost.run server 
     if start == 'phishing':
      ...
      adobe    apple   bitcoin   create   google   instafollowers   messenger   microsoft  myspace   origin     

      paypal   pinterest  playstation  protonmail  shopify   shopping  snapchat  spotify  steam  twitch  twitter 
